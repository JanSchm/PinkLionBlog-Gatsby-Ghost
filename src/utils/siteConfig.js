...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://fluffy-marzipan-7464ad.netlify.app`
            : `https://fluffy-marzipan-7464ad.netlify.app`, // Site domain. Do not include a trailing slash!
